...
public class Main extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sq1= "select * from users where user_name= '" + txtUsername.getText() + "' and password ='" + Hashing.md5().hashString( String.valueOf(jPassword.getPassword()), Charsets.UTF_8 ).toString() + "'";
        try{
